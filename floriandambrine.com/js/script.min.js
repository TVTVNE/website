...
setTimeout(function(){that.tick();},delta);};window.onload=function(){var parallaxBox=document.getElementById('parallax');if(!parallaxBox){return;}
var
...
var css=document.createElement("style");css.type="text/css";css.innerHTML=".txt-rotate > .wrap { border-right: 0.08em solid #666 }";document.body.appendChild(css);})(jQuery);